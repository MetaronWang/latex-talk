...
\begin{frame}{扩展阅读}
  \begin{itemize}
    ...
    % \item \LaTeX杂谈（刘海洋）
    \item 《\LaTeX{} 入门》（刘海洋）
    \item 小红书博主“居然是老余耶”首页（James Yu，\LaTeX{} Workshop作者） \link{https://www.xiaohongshu.com/user/profile/5f829e760000000001009e20}
    ...
    \item 在 \LaTeX{} 环境外显示数学公式，部分宏包：\href{https://www.mathjax.org/}{Mathjax}, \href{https://github.com/kisonecat/tikzjax}{Tikzjax}, \href{https://katex.org/}{KaTeX}
  ...
  \begin{columns}[c]
    \begin{column}{.5\textwidth}
      \begin{itemize}
        ...
        \item 南科大研究生论文模板反馈群：320971126
        \item \TeX StackExchange \url{https://tex.stackexchange.com/}
        \item Google, Bing, etc.
          \begin{itemize}
            \item 使用\alert{\textbf{英语}}搜索
          \end{itemize}
        \item DeepSeek、ChatGPT、Claude等LLM
          \begin{itemize}
            \item 务必复核他们给出的答案是否正确可行
          \end{itemize}
      \end{itemize}
    \end{column}
...
\begin{frame}{感谢}
  \begin{itemize}
    ...
    \item 往年幻灯片下载地址 \url{https://github.com/SUSTech-CRA/latex-talk}
    \item 本幻灯片下载地址 \url{https://github.com/MetaronWang/latex-talk}
  \end{itemize}
\end{frame}
